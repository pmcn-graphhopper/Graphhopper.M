...
public class RouteResource {
    ...
    public Response doGet(
            ...
            @QueryParam("gpx_point") List<GHPoint> gpxPoints,
            @QueryParam("test_param") @DefaultValue("a") String Instr) {
        ...
        if(Instr.equalsIgnoreCase("b")){
            System.out.println("success for your test");
            System.out.println(gpxPoints);
